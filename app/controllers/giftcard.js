...
exports.load = async(function* (req, res, next, id) {
    try {
        req.article = yield GiftCard.load(id);
...
exports.index = async(function* (req, res) {
    ...
    const articles = yield GiftCard.list(options);
    const count = yield GiftCard.count();
...
exports.create = async(function* (req, res) {
    const article = new GiftCard(only(req.body, 'title body tags'));
